...
const AGENT_ID = 'test-agent-doc';
const FILE_PATH = path.join('test', 'sample', 'sample.txt');
const QUESTION = 'What is the flagship product of SmartHarvest?';
const TOKEN = '123456';
