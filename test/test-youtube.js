...
const AGENT_ID = 'test-agent-youtube';
const YOUTUBE_URL = 'https://www.youtube.com/watch?v=NQbCZFRAkSw'; // Use a real, accessible YouTube video
const QUESTION = 'What is the main topic of the YouTube video?';
const TOKEN = '123456';
